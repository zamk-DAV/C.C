...
export const Header: React.FC<HeaderProps> = ({
    ...
    return (
        <header className="flex items-start justify-between px-6 pt-[max(env(safe-area-inset-top),_1.5rem)] pb-6 border-b border-border/40 backdrop-blur-sm sticky top-0 z-50 bg-background/50 transition-all duration-300">
